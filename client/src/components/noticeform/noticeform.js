                    ...
                    <form>
                        <div className={styles.row}>
                            ...
                            <div className={styles.col2}>
                                <input name="title" type="text" id="noticetitle" placeholder="Title" onChange={this.handleChange} />
                            </div>
                        </div>
                        <div className={styles.row}>
                            <div className={styles.col1}>
                            ...
                            <div className={styles.col2}>
                                <textarea id="subject" name="content" placeholder="Specify the details" onChange={this.handleChange}>
                                </textarea>
                            </div>
                        </div>
                        <div className={styles.row}>
