...
class addassignment extends Component {
    render() {
        return (
            <>
                <form><br />
                    <h1><i className="far fa-file-alt"></i> &nbsp; ASSIGNMENT</h1><input type="button" value="Delete"/><input
                        type="submit" value="Assign" /><br />
                    ...
                    <div classNameName={styles.content}>
                        <div className={styles.data}>
                            ...
                            <div className={styles.row}>
                                ...
                                <div className={styles.col_75}>
                                    <textarea name="instructions" placeholder="Description"></textarea>
                                </div>
                            </div>
                            <div className={styles.row}>
                                <div className={styles.col_25}>
                        ...
                        <div className={styles.parameters}>
                            ...
                            <i className="far fa-clock" id="icon"></i><label>Due time: </label>
                            <input type="time" name="duetime" /><br /><br />
