...
class Assignment extends Component {
  ...
  uploadSubmission = (e) => {
    ...
    axios
      .post("assignment/newSubmission", formData, {
  ...
  render() {
    ...
    let date_month = new Date(assignment.createdAt).toLocaleString('en-us', { month: 'short' });
        ...
        <div className={styles.assignment}>
          ...
          <div className={styles.details}>
            <div className={styles.assignment_info}>
              ...
              <p>{assignment.creator} &nbsp;&nbsp;&nbsp;[{date_day} {date_month}]</p>
              <div>
                <div className={styles.points}>{assignment.points} points</div>
                <div className={styles.due_to}> Due {moment(assignment.dueDate).fromNow()}</div>
              </div>
            </div>
            <div className={styles.assignment_attachment}>
              <div className={styles.front_page}></div>
              <div className={styles.file_title}>
                <a href="#">{assignment.filename}</a>
                <p>pdf</p>
              </div>
            </div>
            <hr />
